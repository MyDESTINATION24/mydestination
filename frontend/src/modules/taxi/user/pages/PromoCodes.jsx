...
const MOCK_PROMOS = [
  { id: '1', code: 'My DESTINATION50',  discount: 50,  type: 'flat',    service: 'All Rides',    expiry: '30 Apr 2026', minFare: 100 },
...
const PromoCodes = () => {
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#F8FAFC_0%,#F3F4F6_38%,#EEF2F7_100%)] max-w-lg mx-auto font-sans pb-28 relative overflow-hidden">
      ...
      {/* Header */}
      <header className="bg-white/90 backdrop-blur-md px-5 pt-14 pb-4 sticky top-0 z-20 border-b border-white/80 shadow-[0_4px_20px_rgba(15,23,42,0.05)] md:pt-10">
        ...
        <div className="rounded-[20px] border border-white/80 bg-white/90 shadow-[0_4px_14px_rgba(15,23,42,0.06)] p-4">
          ...
          <div className="flex gap-2">
            <input
              ...
              placeholder="e.g. My DESTINATION50"
