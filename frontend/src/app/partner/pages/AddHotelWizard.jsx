...
import { CheckCircle, FileText, Home, Image, Plus, Trash2, MapPin, Search, Eye, BedDouble, Wifi, Tv, Snowflake, Coffee, ShowerHead, ArrowLeft, ArrowRight, Clock, Loader2, Camera, X } from 'lucide-react';
...
const AddHotelWizard = () => {
  ...
  const handleCameraUpload = async (type, onDone) => {
    try {
      ...
      // Fallback to standard web file picker if Flutter native camera call fails
                  ...
                  <div className="p-4 space-y-4">
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-3 gap-3">
                      <div className="space-y-1">
                        ...
                        <input className="input w-full" type="number" placeholder="Selling price" value={editingRoomType.pricePerNight} onChange={e => setEditingRoomType(prev => ({ ...prev, pricePerNight: e.target.value }))} />
                      </div>
                      <div className="space-y-1">
                        <label className="text-xs font-semibold text-gray-500">Original Price / MRP (₹)</label>
                        <input className="input w-full" type="number" placeholder="Struck through" value={editingRoomType.originalPrice || ''} onChange={e => setEditingRoomType(prev => ({ ...prev, originalPrice: e.target.value }))} />
                      </div>
                      <div className="space-y-1">
                    ...
                    <div className="bg-emerald-50/50 p-3 rounded-xl border border-emerald-100 space-y-3">
                      ...
                      <div className="grid grid-cols-2 gap-3">
                        <div className="space-y-1">
                          ...
                          <input className="input w-full bg-white" type="number" value={editingRoomType.extraAdultPrice} onChange={e => setEditingRoomType(prev => ({ ...prev, extraAdultPrice: e.target.value }))} placeholder="0" />
                        </div>
                        <div className="space-y-1">
                          <label className="text-xs font-semibold text-gray-500">Extra Child Price (₹)</label>
                          <input className="input w-full bg-white" type="number" value={editingRoomType.extraChildPrice} onChange={e => setEditingRoomType(prev => ({ ...prev, extraChildPrice: e.target.value }))} placeholder="0" />
                        </div>
                      </div>
                    </div>
