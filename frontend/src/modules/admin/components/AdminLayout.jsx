        ...
        items: [
          ...
          },
          {
            ...
            subItems: [
              ...
              { label: 'Bus Banners', path: '/admin/bus-service/banners', permission: 'bus_service.view' },
              { label: 'Bus Offers', path: '/admin/bus-service/offers', permission: 'bus_service.view' },
            ],
          },
          {
            icon: Share2,
