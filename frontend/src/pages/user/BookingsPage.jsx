...
const BookingsPage = () => {
    ...
    return (
        <div className="min-h-screen">
            ...
            <div className="sticky top-0 text-white px-5 pt-14 pb-6 rounded-b-3xl shadow-lg z-10" style={{ background: 'var(--color-header-bg, var(--color-theme-gradient, var(--color-surface, #5F8575)))' }}>
