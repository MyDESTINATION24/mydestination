...
const HotelLogin = () => {
    ...
    return (
        <div className="min-h-screen bg-gradient-to-br from-gray-900 via-[#0A4720] to-[#006663] flex items-center justify-center p-4 relative overflow-hidden">
                            ...
                            >
                                ...
                                <div className="flex gap-2 mb-6 bg-gray-100 p-1 rounded-xl">
                                    <button
                                        ...
                                        className={`flex-1 py-2 px-4 rounded-lg font-medium transition-all ${method === 'phone'
                                            ? 'bg-[#0A4720] text-white shadow-md'
                                            : 'text-gray-500'
                                            }`}
                                    >
                                ...
                                <form onSubmit={handleSendOTP} className="space-y-6">
                                    ...
                                    <button
                                        type="submit"
                                        disabled={loading}
                                        className="w-full bg-[#0A4720] text-white py-3 rounded-xl font-bold shadow-lg hover:bg-gray-900 transition-all disabled:opacity-50 flex items-center justify-center gap-2"
                                    >
                                        {loading ? (
                            ...
                            >
                                <div className="text-center mb-6">
                                    <div className="w-16 h-16 bg-sky-100 rounded-full flex items-center justify-center mx-auto mb-4">
                                        <Shield size={32} className="text-[#0A4720]" />
                                    </div>
                                    ...
                                    <div className="flex gap-2 justify-center">
                                        {otp.map((digit, index) => (
                                            <input
                                                ...
                                                className="w-12 h-12 text-center text-xl font-bold border-2 border-gray-400 rounded-xl focus:border-[#0A4720] focus:ring-2 focus:ring-sky-200 outline-none transition-all"
                                            />
                                        ))}
                                    </div>
