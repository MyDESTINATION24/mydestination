    ...
    <div className="bg-white rounded-3xl border border-gray-100 overflow-hidden shadow-sm">
      <div className="px-5 py-4 border-b border-gray-100 flex justify-between items-center">
        ...
        <button
          ...
          className="text-xs font-semibold text-[#0A4720] flex items-center gap-1 hover:gap-2 transition-all"
        >
          ...
          >
            <div className="flex justify-between items-start mb-2">
              ...
              <span className={`px-2 py-0.5 rounded text-[10px] font-bold uppercase tracking-wide
                  ...
                  ${booking.bookingStatus === 'completed' ? 'bg-blue-100 text-[#063818]' : ''}
      ...
      <div className="hidden md:block overflow-x-auto">
        <table className="w-full text-left text-sm text-gray-500">
          <thead className="bg-[#0A4720]/5 text-gray-700">
            <tr>
            ...
            {bookings.map((booking) => (
              <tr key={booking._id} className="hover:bg-gray-50/50 transition-colors">
                ...
                <td className="px-6 py-4">
                  <button
                    onClick={() => navigate(`/hotel/bookings/${booking._id}`)}
                    className="text-[#0A4720] hover:text-gray-900 font-medium text-xs border border-[#0A4720]/20 px-3 py-1.5 rounded-lg hover:bg-[#0A4720]/5 transition"
                  >
                    Details
                  </button>
                </td>
