...
const PoolingList = () => {
  ...
  return (
    <div className="min-h-screen bg-slate-50 mx-auto w-full max-w-lg lg:max-w-4xl font-sans pb-24 selection:bg-amber-100">
      {/* Immersive Header */}
      <div className="sticky top-0 z-50 bg-white/80 backdrop-blur-xl px-5 pt-12 pb-6 shadow-sm border-b border-slate-100">
        <div className="flex items-center gap-4 mb-6">
          ...
          <div className="flex-1 overflow-hidden">
            ...
            <div className="flex items-center gap-2 mt-1">
               ...
               <span className="bg-amber-50 text-amber-600 text-[9px] font-black px-2 py-0.5 rounded-full uppercase tracking-wider">Step 1/3</span>
            </div>
          </div>
        ...
        <div className="flex items-center gap-2 px-1">
          <div className="h-1.5 flex-1 rounded-full bg-amber-600 shadow-[0_0_8px_rgba(79,70,229,0.4)]" />
        ...
        {loading ? (
          ...
          >
            <div className="mb-8 relative">
               <div className="h-32 w-32 rounded-full bg-amber-50/50 flex items-center justify-center text-amber-100 animate-pulse" />
               <Car size={56} className="absolute inset-0 m-auto text-amber-200" />
            </div>
            ...
            <button 
              onClick={() => navigate('/taxi/user/pooling')}
              className="mt-10 flex items-center gap-2 text-xs font-black uppercase tracking-[0.2em] text-white px-8 py-4 bg-amber-600 rounded-[20px] shadow-2xl shadow-slate-200 active:scale-95 transition-all"
            >
              <ArrowLeft size={16} />
              Modify Search
            </button>
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between px-3">
               ...
               <div className="flex items-center gap-1.5 text-[10px] font-black text-amber-600 bg-amber-50 px-3 py-1 rounded-full uppercase tracking-widest">
                  <ShieldCheck size={12} />
                  Verified
               </div>
            </div>
            ...
            {routes.map((route, idx) => {
              ...
              return (
                <motion.div
                  ...
                  className="group relative overflow-hidden rounded-[40px] border border-white bg-white p-7 transition-all hover:border-amber-100 hover:shadow-[0_40px_80px_-16px_rgba(15,23,42,0.1)] cursor-pointer"
                >
                  {/* Decorative Elements */}
                  <div className="absolute top-0 right-0 -mr-16 -mt-16 h-48 w-48 rounded-full bg-slate-50/50 blur-3xl group-hover:bg-amber-50/50 transition-colors" />
                  
                  <div className="flex items-start justify-between relative z-10">
                    <div className="space-y-5 flex-1 pr-4">
                      <div className="flex items-start gap-4">
                        <div className="relative flex flex-col items-center pt-2">
                          <div className="h-3 w-3 rounded-full border-2 border-amber-600 bg-white z-10 shadow-[0_0_8px_rgba(79,70,229,0.3)]" />
                          <div className="h-12 w-0.5 border-l-2 border-dashed border-slate-100" />
                          <div className="h-3 w-3 rounded-full bg-amber-600 z-10 ring-4 ring-slate-50" />
                        </div>
                  ...
                  <div className="mt-8 flex items-center justify-between border-t border-slate-50 pt-7">
                    <div className="flex items-center gap-4">
                      <div className="relative">
                        ...
                        <div className="absolute -right-1 -bottom-1 h-4 w-4 rounded-full bg-amber-500 border-2 border-white flex items-center justify-center">
                    ...
                    <div className="flex items-center gap-4">
                      ...
                      <div className="flex h-11 w-11 items-center justify-center rounded-[18px] bg-amber-600 text-white shadow-xl shadow-slate-200 group-hover:bg-amber-600 group-hover:shadow-amber-100 transition-all">
