    ...
    () => [
      {
        ...
        items: [
          ...
          },
          {
            ...
            label: 'Airways',
            subItems: [
              { label: 'Airway Manager', path: '/taxi/admin/airways', permission: 'airways.view' },
              { label: 'Airway Routes', path: '/taxi/admin/airways/routes', permission: 'airways.view' },
              { label: 'Airway Bookings', path: '/taxi/admin/airways/bookings', permission: 'airways.view' },
            ],
          },
          {
            icon: Compass,
