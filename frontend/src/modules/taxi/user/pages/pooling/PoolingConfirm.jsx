...
const PoolingConfirm = () => {
    ...
    return (
      <div className="flex h-screen flex-col items-center justify-center bg-white p-6 text-center">
        ...
        <button
          ...
          className="mt-10 flex items-center gap-2 rounded-2xl bg-amber-600 px-8 py-4 text-xs font-black uppercase tracking-widest text-white shadow-2xl shadow-slate-200 transition-all hover:bg-amber-500 active:scale-95"
        >
          <ArrowLeft size={16} />
          Restart Booking
        </button>
  ...
  return (
    <div className="mx-auto min-h-screen w-full max-w-lg lg:max-w-3xl bg-slate-50 pb-32 font-sans selection:bg-amber-100">
        ...
        {isBooked ? (
          ...
          >
            <div className="overflow-hidden rounded-[40px] border border-white bg-white shadow-[0_32px_64px_-12px_rgba(15,23,42,0.12)]">
              <div className="relative bg-gradient-to-br from-amber-500 via-amber-600 to-amber-600 px-6 pb-12 pt-10 text-white">
                ...
                <div className="relative z-10 flex items-start justify-between gap-4">
                  <div>
                    <motion.p 
                      ...
                      className="text-[11px] font-black uppercase tracking-[0.25em] text-amber-100"
                    >
                      Booking Successful
                    </motion.p>
                    <motion.h1 
                  ...
                  >
                    <p className="text-[10px] font-black uppercase tracking-widest text-amber-100">Booking ID</p>
              ...
              <div className="relative -mt-8 space-y-5 rounded-t-[40px] bg-white px-6 pb-8 pt-10">
                <div className="grid grid-cols-2 gap-4">
                  <div className="rounded-3xl border border-slate-100 bg-slate-50/50 p-5 transition-all hover:bg-slate-50">
                    ...
                    <div className="mt-4 flex items-start gap-3">
                      <div className="flex h-8 w-8 items-center justify-center rounded-xl bg-white text-amber-600 shadow-sm">
                  ...
                  <div className="rounded-3xl border border-slate-100 bg-slate-50/50 p-5 transition-all hover:bg-slate-50">
                    ...
                    <div className="mt-4 flex items-start gap-3">
                      ...
                      <div>
                        ...
                        <p className="mt-0.5 text-[10px] font-bold text-amber-600 uppercase tracking-widest flex items-center gap-1">
                          <ShieldCheck size={10} />
                          PAID
                        </p>
                      </div>
                ...
                <div className="group relative overflow-hidden rounded-[32px] border border-slate-100 bg-white p-5 shadow-sm transition-all hover:shadow-md">
                  <div className="flex items-center gap-5">
                    ...
                    <div className="min-w-0 flex-1">
                      ...
                      <p className="mt-0.5 text-xs font-bold uppercase tracking-[0.15em] text-amber-600">{vehicle.vehicleNumber}</p>
                ...
                <div className="rounded-[32px] border border-slate-100 bg-white p-6 shadow-sm">
                  ...
                  <div className="relative mt-2 flex items-start gap-5">
                    <div className="relative flex flex-col items-center pt-1.5">
                      <div className="z-10 h-3 w-3 rounded-full border-2 border-amber-500 bg-white shadow-[0_0_10px_rgba(16,185,129,0.3)]" />
                      <div className="h-14 w-0.5 border-l-2 border-dashed border-slate-200" />
                      <div className="z-10 h-3 w-3 rounded-full bg-amber-600 ring-4 ring-slate-50" />
                    </div>
                ...
                <div className="rounded-[32px] border border-amber-100 bg-amber-50/50 p-5">
                  <div className="flex items-start gap-4">
                    <div className="mt-1 rounded-xl bg-amber-100 p-2 text-amber-600">
                      <Info size={18} />
                    </div>
                    <div>
                      <p className="text-[10px] font-black uppercase tracking-[0.2em] text-amber-700">Next Steps</p>
                ...
                <div className="grid grid-cols-2 gap-4 pt-4">
                  ...
                  <button
                    ...
                    className="rounded-3xl bg-amber-600 px-4 py-5 text-sm font-black text-white shadow-[0_20px_40px_-12px_rgba(15,23,42,0.4)] transition-all hover:bg-amber-500 active:scale-[0.98]"
                  >
                    Go Home
                  </button>
                </div>
          ...
          <>
            ...
            <div className="space-y-6 px-5 pt-8">
              ...
              >
                <div className="overflow-hidden rounded-[44px] border border-white bg-white shadow-[0_32px_64px_-16px_rgba(15,23,42,0.1)]">
                  ...
                  <div className="relative bg-amber-600 px-8 py-10 text-white overflow-hidden">
                    <div className="absolute right-0 top-0 -mr-16 -mt-16 h-64 w-64 rounded-full bg-amber-600/20 blur-3xl" />
                    ...
                    <div className="relative z-10 mt-8 flex items-center gap-6">
                      ...
                      <div className="flex-1 min-w-0">
                        ...
                        <p className="mt-1 text-xs font-black uppercase tracking-[0.2em] text-amber-400">{vehicle.vehicleNumber}</p>
                        <div className="mt-4 flex items-center gap-3">
                          <div className="flex -space-x-2">
                            {[...Array(Math.min(3, selectedSeats.length))].map((_, i) => (
                              <div key={i} className="h-6 w-6 rounded-full border-2 border-amber-600 bg-amber-500 flex items-center justify-center text-[10px] font-black">
                                <Armchair size={10} />
                              </div>
                            ))}
                          </div>
                  ...
                  {/* Perforated Divider */}
                  <div className="relative h-6 bg-amber-600">
                  ...
                  <div className="space-y-8 bg-white p-8">
                    ...
                    <div className="relative flex items-start gap-6 pt-2">
                      <div className="relative flex flex-col items-center pt-1.5">
                        <div className="z-10 h-3.5 w-3.5 rounded-full border-[3px] border-amber-500 bg-white" />
                        <div className="h-20 w-0.5 border-l-2 border-dashed border-slate-100" />
                        <div className="z-10 h-3.5 w-3.5 rounded-full bg-amber-600 ring-4 ring-amber-50" />
                        <Navigation size={14} className="absolute -bottom-7 text-amber-600 animate-bounce" />
                      </div>
              ...
              >
                ...
                <div className="space-y-5">
                  ...
                  <div className="flex justify-between items-center text-sm font-bold text-slate-500">
                    ...
                    <span className="font-black uppercase text-amber-500">Free</span>
                  </div>
                  ...
                  <div className="mt-8 flex items-end justify-between border-t border-slate-50 pt-8">
                    ...
                    <div className="mb-1">
                      <div className="rounded-xl bg-amber-600 px-4 py-2.5 text-[10px] font-black uppercase tracking-widest text-white shadow-lg">
                        Proceed to Pay
                      </div>
                    </div>
                  </div>
              ...
              <motion.div 
                ...
                className="group relative overflow-hidden rounded-[32px] border-2 border-dashed border-slate-200 bg-white p-6 transition-all hover:border-amber-300 hover:bg-amber-50/10"
              >
                <div className="flex items-center justify-between">
                  <div className="flex items-center gap-5">
                    <div className="flex h-14 w-14 items-center justify-center rounded-[20px] bg-slate-50 text-slate-900 shadow-inner group-hover:bg-white group-hover:text-amber-600 transition-colors">
                      <CreditCard size={26} />
                    </div>
                    <div>
                  ...
                  <div className="flex flex-col items-end gap-2">
                    <div className="rounded-full bg-amber-50 px-3 py-1 text-[9px] font-black uppercase tracking-widest text-amber-600">
                      Active
                    </div>
            ...
            <div className="fixed bottom-0 left-1/2 z-50 w-full max-w-lg lg:max-w-3xl -translate-x-1/2">
              <div className="mx-5 mb-8 overflow-hidden rounded-[32px] bg-amber-600/90 p-2 shadow-[0_24px_50px_-12px_rgba(15,23,42,0.4)] backdrop-blur-xl border border-white/10">
                <button
                  type="button"
