...
const Notifications = () => {
  ...
  return (
    <div className="min-h-screen bg-[linear-gradient(180deg,#F8FAFC_0%,#F3F4F6_38%,#EEF2F7_100%)] max-w-lg mx-auto font-sans pb-28 relative overflow-hidden">
      ...
      {/* Header */}
      <header className="bg-white/90 backdrop-blur-md px-5 pt-[calc(env(safe-area-inset-top)+1.5rem)] pb-4 sticky top-0 z-20 border-b border-white/80 shadow-[0_4px_20px_rgba(15,23,42,0.05)]">
